...
- name: [Вид] [Бренд] [характеристика]. Регистр: первое слово заглавное, бренды заглавные.
  ...
  Примеры: "крым лимонад 2 литра пак 10шт"→name="Лимонад Крым 2л", qty=10, unit="шт"
